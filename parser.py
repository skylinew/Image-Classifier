...
def digitistrue(training_list, number):
    return len(training_list[number])/5000


def digitisfalse(training_list, number):
    return 1 - digitistrue(training_list, number)
